...
import ChatMessage from "./ChatMessage"; // Fixed typo
...
function ChatBot() {
    ...
    const apiUrl = import.meta.env.VITE_API_URL || "http://default-api-url.com"; // Fallback URL
    ...
    const generateBotResponse = async (history) => {
        ...
        try {
            ...
            const apiResponseText = data.candidates[0].content.parts[0].text
                ...
                .replace(/_(.*?)_/g, "$1")       // Remove italics markdown
                .trim();
        ...
        <div className="container font-[poppins]">
            <div className="chatbot-popup relative w-[420px] overflow-hidden bg-[#fff] rounded-lg shadow-lg">
                ...
                <div className="chat-header flex px-6 py-4 items-center justify-between bg-[#6d4fc2]">
                    ...
                    <button className="material-symbols-outlined h-10 w-10 border-none outline-none text-[#fff] cursor-pointer text-[28px] pt-1 rounded-full bg-none hover:bg-[#593bab] transition-all duration-200 ease-in-out">
                        keyboard_arrow_down
                    </button>
                </div>
                ...
                <div ref={chatBotRef} className="chat-body h-[460px] overflow-y-auto p-6 flex flex-col gap-5">
                    <div className="massage bot-massage flex gap-3 items-center">
                        <svg className="h-9 w-9 p-2 fill-[#fff] bg-[#6d4fc2] rounded-full" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 1024 1024">
